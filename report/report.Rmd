...
```{r, message=F,echo=F}
data %>%
	ggplot(aes(x=conservative_action, y=moral_just, group=factor_ideo5, col=factor_ideo5)) +
	geom_smooth(aes(weight=weight_pol), method="lm") +
	ggtitle("Interaction Effects of Ideology / Conservative Action on Perception\nOf Moral Justification") +
	xlab("Conservative Action") +
	ylab("Moral Justification") +
	labs(col = "Respondent Ideology")
```
...
```{r, message=F,echo=F}
data %>%
	ggplot(aes(x=conservative_action, y=strategic, group=factor_ideo5, col=factor_ideo5)) +
	geom_smooth(aes(weight=weight_pol), method="lm") +
	ggtitle("Interaction Effects of Ideology / Conservative Action on Perceptions\nOf Strategy") +
	xlab("Conservative Action") +
	ylab("Agreement Action is Strategic") +
	labs(col = "Respondent Ideology")
...
```{r, message=F,echo=F}
data %>%
	ggplot(aes(x=conservative_action, y=terrorism, group=factor_ideo5, col=factor_ideo5)) +
	geom_smooth(aes(weight=weight_pol), method="lm") +
	ggtitle("Interaction Effects of Ideology / Conservative Action on Perceptions of Terroism") +
	xlab("Conservative Action") +
	ylab("Agreement Action is Terroism") +
	labs(col = "Respondent Ideology")
```
