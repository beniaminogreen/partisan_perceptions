...
sum_all <- lm(sum ~ treat, data = cleaned_data, weights=weight_1)
sum_att <- lm(sum ~ treat, data = attentive, weights=weight_1)
...
save(support_treat, support_treat_att, support_treat_ideo5_dbl,
     ...
     sum_treat_pvote, sum_treat_pvote_att, sum_treat_x_pvote, sum_all, sum_att,
     sum_treat_x_pvote_att, pca_treat_x_pid3_att, pca_treat_pvote,
     pca_treat_pvote_att, pca_treat_x_pvote, pca_treat_x_pvote_att,
